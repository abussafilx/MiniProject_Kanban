...
function Board(props) {
  ...
  const handleDrop = (e) => {
    ...
    if (
      e.target.parentNode.parentNode.id === "To Do" ||
      e.target.parentNode.parentNode.id === "Done" ||
      e.target.parentNode.parentNode.id === "In Progress"
    ) {
      props.setTasks((prev) =>
        prev.map((task) =>
          task.id === currentId
            ? { ...task, status: e.target.parentNode.parentNode.id }
            : task
        )
      );
      toast("Task Updated");
    ...
    <div className="kanban-board">
      ...
      >
        <h3>
          ...
          {dragging && <p className="drop-area">drop here</p>}
        </h3>
